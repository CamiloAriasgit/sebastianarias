...
export default function Hero() {
  return (
    <section className="relative flex min-h-[90svh] pt-40 w-full flex-col items-center justify-center overflow-hidden bg-[#F6F8FB] px-6 py-20 selection:bg-lime-400 selection:text-neutral-900">
