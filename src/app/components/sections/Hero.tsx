...
export default function Hero() {
  return (
    <section className="relative flex min-h-[95svh] md:min-h-[90svh] pt-30 md:pt-36 w-full flex-col items-center justify-center overflow-hidden bg-[#F6F8FB] px-0 py-20 selection:bg-lime-400 selection:text-neutral-900">
