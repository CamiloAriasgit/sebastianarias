  ...
  return (
    <section className="w-full bg-neutral-950 px-6 py-24 sm:py-32 border-t border-white/5">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-1 font-sans text-lg md:text-2xl font-bold leading-[0.9] text-neutral-500">
          ...
          <p className="pt-5 bg-gradient-to-r from-blue-500 via-pink-500 to-yellow-500 bg-clip-text text-transparent">
