...
export default function Hero() {
    return (
        <section className="relative flex min-h-[99svh] md:min-h-[90svh] md:pt-36 w-full flex-col items-center justify-center overflow-hidden bg-neutral-950 px-4 py-20 selection:bg-lime-400 selection:text-neutral-900">
