  ...
  return (
    <section className="flex flex-col items-center text-center space-y-10 pt-20 md:pt-10">
      <motion.div
        ...
        className="space-y-6"
      >
        <h1 className="text-4xl md:text-8xl font-medium tracking-tight leading-[0.9] bg-clip-text text-transparent bg-gradient-to-b from-white to-white/40">
      ...
      >
        <button className="px-6 py-4 bg-white text-black rounded-full font-medium text-sm transition-transform hover:scale-105 active:scale-95">
          Empezar
        </button>
