    ...
    return (
        <section ref={ref} className="relative min-h-screen flex flex-col items-center justify-center text-center px-4">
            ...
            <a
                ...
                className="pt-10"
            >
                <div className="group relative flex items-center justify-center gap-3 overflow-hidden rounded-full bg-white/70 px-5 py-2 text-lg text-black transition-all active:scale-95 shadow-inner shadow-white">
                    <span>Empezar</span>
