...
export default function ProcessSection() {
    ...
    return (
        <section className="w-full bg-[#F6F8FB] px-6 ">
            <div className="mx-auto max-w-5xl">
                ...
                <div className="flex flex-col items-center gap-8 sm:hidden">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <h3 className="font-sans text-2xl font-semibold tracking-tight text-neutral-900 leading-tight">
                                {features[activeIndex].title}
                            </h3>
                            <p className="mt-3 font-sans text-base font-medium text-neutral-500 leading-tight">
