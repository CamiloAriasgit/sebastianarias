            ...
            <div className="mx-auto max-w-5xl">
                ...
                <div className="flex flex-col items-center gap-8 sm:hidden">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <h3 className="font-sans text-base font-medium tracking-tight text-neutral-900 leading-tight">
                                {features[activeIndex].title}
                            </h3>
                            <p className="mt-1 font-sans text-base font-medium text-neutral-500 leading-tight">
