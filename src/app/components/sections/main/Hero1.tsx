        ...
        <section className="relative flex w-full padding-block min-h-[100svh] bg-section overflow-hidden">
            ...
            <div className="hidden lg:flex flex-col w-full lg:py-30 justify-center z-20 container-site gap-12">
                ...
                <div className="grid grid-cols-2 gap-8 items-start w-full">
                    ...
                    {/* Columna Derecha */}
                    <div className="flex justify-end items-start text-left pt-2 w-full">
                        <p
                            className="text-base md:text-lg text-balance leading-relaxed text-neutral-700 m-0 w-70 ml-auto"
                        >
                ...
                <div className="w-full bg-gradient-to-b from-white via-white to-white rounded-xl overflow-hidden relative flex justify-center h-[450px]">
