              ...
              {STEPS.map((step, i) => {
                ...
                return (
                  <button
                    key={step.number}
                    onClick={() => setActive(i)}
                    className="relative flex-1 md:flex-none p-3 md:px-5 md:py-2.5 bg-transparent border-none cursor-pointer rounded-full flex items-center justify-center gap-2 transition-colors duration-200 select-none outline-none group"
                    style={{ 
