    ...
    return (
        <section className="relative w-full h-svh flex items-center justify-center pt-14 bg-white overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: `
    radial-gradient(circle at 15% 15%, #0022FF 0%, transparent 99%),
    radial-gradient(circle at 85% 20%, #031273 0%, transparent 99%),
    radial-gradient(circle at 50% 50%, #031273 0%, transparent 99%),
    radial-gradient(circle at 20% 80%, #031273 0%, transparent 99%),
    radial-gradient(circle at 80% 85%, #031273 0%, transparent 99%)
`
                }}
            />
