        ...
        >
            <div className="container-site">
                ...
                <div className="flex flex-col items-center justify-center w-full">
                    <div
                        className="relative w-full max-w-2xl rounded-2xl bg-white border border-neutral-200 px-8 py-12 md:px-12 md:py-14 shadow-xl shadow-neutral-200/60 overflow-hidden"
